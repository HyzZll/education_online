package com.hyz.vodservice.controller;
...
import com.hyz.commonutils.R;
import com.hyz.vodservice.utils.AliyunVodSDKUtils;
...
public class VideoAdminController {
    ...
    public R uploadVideo(MultipartFile file){
        ...
        try {
            ...
            UploadStreamRequest request = new UploadStreamRequest(
                    "LTAI5tF7Ko6Uo3Sf3CW4H6JD",
                    "i646TctaFaPN4fPlhyYjMJD2d3HWO1",
                    title,
                    originalFilename,
                    inputStream
            );
    ...
    public R delVideo(@PathVariable("videoId") String videoId){
        ...
        try {
            //*初始化客户端对象
            DefaultAcsClient client = AliyunVodSDKUtils.initVodClient("LTAI5tF7Ko6Uo3Sf3CW4H6JD",
                    "i646TctaFaPN4fPlhyYjMJD2d3HWO1");
            //*创建请求对象（不同操作，类不同）
